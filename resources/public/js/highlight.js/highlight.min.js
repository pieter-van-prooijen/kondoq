...
subLanguage:"bash"}}]})})();hljs.registerLanguage("shell",s)})();/*! `clojure` grammar compiled for Highlight.js 11.5.1 */
(()=>{var e=(()=>{"use strict";return e=>{
...
;hljs.registerLanguage("clojure",e)})();/*! `go` grammar compiled for Highlight.js 11.5.1 */
...
;hljs.registerLanguage("python-repl",a)})();/*! `clojure-repl` grammar compiled for Highlight.js 11.5.1 */
(()=>{var e=(()=>{"use strict";return e=>({name:"Clojure REPL",contains:[{
className:"meta.prompt",begin:/^([\w.-]+|\s*#_)?=>/,starts:{end:/$/,
subLanguage:"clojure"}}]})})();hljs.registerLanguage("clojure-repl",e)})();/*! `diff` grammar compiled for Highlight.js 11.5.1 */
